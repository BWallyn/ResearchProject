...
#--------------------------
    ...
    def entropy_flux_at_x(q, index):
        ...
        u_1i=q[1,index] / q[0,index]
        u_2i=q[3,index] / q[2,index]
        entropy_flux_at_x = rho[0]*(h_1i*u_1i**2/2+g*h_1i**2)*u_1i + rho[1]*(h_2i*u_2i**2/2+g*h_2i**2)*u_2i + rho[0]*g*h_1i*h_2i*(u_1i+u_2i) + g*b[index]*(rho[0]*h_1i*u_1i+rho[1]*h_2i*u_2i)
